...
manualTesting = do
    let
        message = toByteString . decode' @Hexadecimal $ "68656c6c6f2c20776f726c64"
        pair =
            KeyPair
                { signatureKey = fromString @(PrivateKey Ed25519DSIGN) "703a8f691df8a74a415bc1297f9d5fbd595cdc42c0defdca636a1beb7f24852d"
                , verificationKey = fromString @(PublicKey Ed25519DSIGN) "3a25f5e2af122ccbb607251303cc61e48caaef42a4fd2f11ddfdc9435871d806"
                }
    ...
    putStrLn "expected signedMessage:0x9adfcd820533d73e7cf6b660e6511d6342202f0bd2ee1ecd7e5348431487fb5c82710080c405f9466f5885f43ffcc26e12378e938bfd6a3d14d7794d28d16306"
